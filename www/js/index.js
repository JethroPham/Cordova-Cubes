...
var app = {
    ...
    bindEvents: function() {
        ...
        function init() {
            ...
            info.innerHTML = '<span style="color: #444; background-color: #fff; border-bottom: 1px solid #ddd; padding: 8px 10px; text-transform: uppercase;"><strong>0 - 9</strong>: colors, <strong>click</strong>: add voxel, <strong>shift + click</strong>: remove voxel, <strong>drag</strong>: rotate | <a id="link" href="" target="_blank">share</a> <a id="save" href="">save</a> <a id="clear" href="">clear</a></span>';
